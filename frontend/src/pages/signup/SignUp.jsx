...
function SignUp() {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
      ...
      <h1 className='text-3x1 font-semibold text-center text-gray-300'>Textify Signup
            </h1>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label className='label p-2'>
                        ...
                        <input type="text" placeholder='Niket Chawla' className='w-full input input-bordered h-10' value={inputs.fullName} onChange={(e)=> setInputs({...inputs,fullName:e.target.value})} />
                </div>
                ...
                <label className='label p-2'>
                        ...
                        <input type="text" placeholder='niket123' className='w-full input input-bordered h-10' value={inputs.username} onChange={(e)=> setInputs({...inputs,username:e.target.value})} />
                </div>
